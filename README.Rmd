...
This documents outlines a simple way to reliably setup R on a WUR windows machine. I took the time to write it because of the release of R 4.0. That way WUR folks can have a set of guidelines to efficiently update their machine.
...
For Rstudio to work smoothly with R 4.0, you need to install Rstudio version 1.3.
...
And _eh voilà_ ! You should be ready with a sound and safe R 4.0 setup !
